...
<!--
**dear-devil0147/dear-devil0147** is a ✨ _special_ ✨ repository because its `README.md`(this filesname: CI
...
```bash
npm installnpm startnpm testnpm run buildnpm run build.
├── src/                 # Source code
├── public/              # Static assets
├── vite.config.js       # Vite configuration
├── vitest.config.js     # Vitest configuration
└── package.json         # Project dependenciesimport { defineConfig } from 'vitest/config';
